...
public class OTUtils {
    ...
    public static List<String> updateRendition(String assetId) {
        ...
        try {
            ...
            log.info("update_rendition API URL: " + BASE_URL + "assets/" + assetId + "/contents");
            ...
            ResponseEntity<String> entity = restTemplate.exchange(BASE_URL + "assets/" + assetId + "/contents", HttpMethod.POST, request, String.class);
            ...
            entity = restTemplate.exchange(BASE_URL + "assets/" + assetId + "/contents", HttpMethod.POST, request, String.class);
